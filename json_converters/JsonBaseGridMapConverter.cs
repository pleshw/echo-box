...
public class JsonBaseGridMapConverter : JsonConverter<IGridMapComponent>
{
  public override IGridMapComponent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
  ...
  public override void Write(Utf8JsonWriter writer, IGridMapComponent value, JsonSerializerOptions options)
  {
