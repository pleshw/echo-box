...
public class JsonGatherConverter : JsonConverter<GatherComponent>
{
  public override GatherComponent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    return JsonSerializer.Deserialize(doc.RootElement.GetRawText(), typeof(IGatherComponent), options) as GatherComponent ?? throw new JsonException($"Invalid Conversion for: {typeName}"); ;
  }

  public override void Write(Utf8JsonWriter writer, GatherComponent value, JsonSerializerOptions options)
  {
